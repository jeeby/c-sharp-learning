public sealed class ChallengesWithEqualityChecks
{
    public void RunExample()
    {
        ...
        // Classes equate as false because they're reference types, and the referenced memory is different,
        // even though the values within are the same
        ...
        // Structs equate as equal because they're value types
        // 
    ...
    public class MyClassWithEquality
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            // Extended code checks the individual values on the object to ensure they're equal
            var other = (MyClassWithEquality)obj;
            return NumericValue == other.NumericValue && StringValue == other.StringValue;
        }

        // Also need to implement GetHashCode() function
        // More info: https://ericlippert.com/2011/02/28/guidelines-and-rules-for-gethashcode/
