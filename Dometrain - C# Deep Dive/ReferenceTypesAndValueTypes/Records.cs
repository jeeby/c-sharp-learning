internal class Records
{
    public void RunExample()
    {
        ...
        // DTOs are simple objects that exist to transfer data around, they generally
    ...
    // The init keyword tells the Record to create the property at object creation time (like with a constructor)
    // but don't allow them to change after that
