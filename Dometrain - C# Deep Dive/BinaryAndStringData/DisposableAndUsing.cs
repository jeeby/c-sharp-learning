public sealed class DisposableAndUsing
{
    public void RunExample()
    {
        ...
        // If a class implements IDisposable, then you're expected to call Dispose() when you're done with it
        //  eg: Streams, network resources, etc
        ...
        // This has the same behavior as we just looked at, but it's arguable a lot easier to read and understand
        // it also ensures that we can have a variable defined just for the scope of the block, where you'll notice
        ...
        // This is a feature from C# 8.0 that allows us to use the "using" statement without the block!
        // - no indentation or curly braces
        // - same functionality
        // - ... but maybe less obvious when it will dispose?
        // the answer to that is that it will dispose as soon as the variable goes out of scope.
        // if you want more tight control, the previous way may be better.
    }
