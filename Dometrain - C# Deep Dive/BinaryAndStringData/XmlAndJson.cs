...
public sealed class XmlAndJson
{
    ...
    {
        // there are two very popular file formats that we often work with as programmers:
        // - XML
        // - JSON
...
// ======================= XML =================================
    ...
    """;
        ...
        // how might the XmlDocument class understand how to go between the binary data of the file
        // and the text representation of the XML?
        // Probably using streams to read the data in, and an encode method like we learned about previously

        // we can use the SelectNodes method to select nodes in the XML the parameter that we pass in for being able to select
        // different data is called "XPath"
        XmlNodeList? people = xmlDocument.SelectNodes("/people/person");

        // Tons of other options available on xmlDocument - try it out and see what's there
...
// ======================= JSON =================================
        ...
        // Bang operator (!) on end tells compiler that what is being returned will never be null.
