public sealed class Interfaces
{
    public void RunExample()
    {
        ...
        // You can cast directly from a concrete class to an interface
        Motorcycle moto = new();
        IMotorized ducati = moto;

        // you can't cast the other way (you can but might get runtime exceptions as
        //   you can't be sure that the IMotorized is actually a Motorcycle
        Motorcycle honda = (Motorcycle)ducati;
    }
